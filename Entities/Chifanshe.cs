...
//
// Auto-generated from chifanshe_com on 2012-03-30 13:01:10Z.
...
namespace cfs
{
	...
	public partial class food : System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		#region Children
		[Association(Storage="_orders", OtherKey="foodId", ThisKey="id", Name="order_ibfk_1")]
		[DebuggerNonUserCode()]
	...
	public partial class order : System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		private EntityRef<food> _food = new EntityRef<food>();
		...
		[Column(Storage="_foodID", Name="foodId", DbType="int", AutoSync=AutoSync.Never, CanBeNull=false)]
		[DebuggerNonUserCode()]
		public int foodId
		{
			get
			...
			set
			{
				if ((_foodID != value))
				{
					if (_food.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		#region Parents
		[Association(Storage="_food", OtherKey="id", ThisKey="foodId", Name="order_ibfk_1", IsForeignKey=true)]
		[DebuggerNonUserCode()]
		public food food
		{
			get
			...
			set
			{
				if (((this._food.Entity == value) 
							== false))
				{
					if ((this._food.Entity != null))
					{
						food previousfood = this._food.Entity;
						this._food.Entity = null;
						previousfood.orders.Remove(this);
					}
